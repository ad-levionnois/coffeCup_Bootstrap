      ...
      <div class="contenair-fluid">
        <div class="col-sm">
          ...
          <img class="logo-header"src="img/logo_coffee.png" alt="logo">
            <div class="contenair">
             <h1>Coffee</h1>
               <p class="headline"> Everything You Love About Coffee </p>
...
<section class="Specialties">
  	<h2> Our specialties</h2>
    	<div class="container-fluid">
      		<div class="row">
        		<div class="col-sm-2">
            		<img src="img/dark_coffees.png" class="card-img-top" alt="dark_coffees">
        		</div>
       		   <div class="col-sm-2">
       			     <h4 class="card-title">Dark Coffees</h4>
              		 <div class="card-body">
                		   <p> Lorem ipsum dolor sit amet, consectetur adipis
                  		     cing elit, sed do eiusmod tempor incididunt ut
                  		     labore et dolore magna aliqua. Ut enim ad
                 		       minim veniam, quis nostrud exercitation
                 		       ullamco laboris nisi ut aliquip ea commodo
  		   ...
  		   <div class="col-sm-2">
        	  <img src="img/cold_coffees.png" class="card-img-top" alt="cold_coffees">
  		   </div>
  	      <div class="col-sm-2">
		          <h4 class="card-title">Cold Coffees</h4>
         	       <div class="card-body">
            	      <p>Lorem ipsum dolor sit amet, consectetur adipis
              	       cing elit, sed do eiusmod tempor incididunt ut
              	       labore et dolore magna aliqua. Ut enim ad
          ...
          <div class="col-sm-2">
            <img src="img/hot_coffees.png" class="card-img-top" alt="hot_coffees">
          </div>
          <div class="col-sm-2">
            <h4 class="card-title">Hot Coffees</h4>
    	         <div class="card-body">
        	        <p>Lorem ipsum dolor sit amet, consectetur adipis
          	         cing elit, sed do eiusmod tempor incididunt ut
          	         labore et dolore magna aliqua. Ut enim ad
...
<section class="offer">
  <div class="row">
    <div class="col-md-6">
      <img class="free" src="img/offer.png" alt="offer">
    </div>
</section>
...
<section class="about_us">
  <div class="container">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
        Excepteur sint occaecat cupidatat non proident. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
    ...
    <div class="container-fluid">
      <h2>Our branches</h2>
        <div class="row">
          <div class="col-sm">
            <div class="card">
              <img src="img/new_york.png" class="card-img-top" alt="new_york">
                <div class="card-body">
            ...
            <div class="col-sm">
              <div class="card">
                <img src="img/texas.png" class="card-img-top" alt="texas">
                  <div class="card-body">
                    <h4 class="card-title">Texas</h4>
                  </div>
              </div>
            </div>
            <div class="col-sm">
              <div class="card">
                <img src="img/new_jorsy.png" class="card-img-top" alt="new_jorsy">
                  <div class="card-body">
                    <h4 class="card-title">New Jorsy</h4>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="container">
  	<div class="customer_reviews">
    	<h2>Customer Reviews </h2>
      	<div class="row">
        	<div class="col-md-6">
          	<img src="img/customer_reviews.png" class="card-img-top" alt="customer_reviews">
        	</div>
      			<div class="col-md-6">
        			<h3>John Peter </h3>
